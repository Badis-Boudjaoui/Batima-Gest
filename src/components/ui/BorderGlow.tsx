import React, { useRef, useCallback, useEffect, ReactNode, PointerEvent as ReactPointerEvent } from 'react';
...
const BorderGlow = ({
  ...
  const getCursorAngle = useCallback((el: HTMLElement, x: number, y: number) => {
    ...
    // On remplace le +90 par -90 (ce qui équivaut à ajouter 180 degrés)
    // car le conic-gradient dans le CSS place la couleur à 180deg du point de départ.
